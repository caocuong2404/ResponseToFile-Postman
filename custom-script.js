...
app.post('/write', (req, res) => {
  let email_res = JSON.parse(req.body.responseData).data.user.email; // edited
  console.log("🚀 ~ file: script.js ~ line 24 ~ app.post ~ email_res", email_res)
  ...
  let extension = req.body.fileExtension || defaultFileExtension,
    ...
    filename = email_res || `${req.body.requestName}${uniqueIdentifier}`,
